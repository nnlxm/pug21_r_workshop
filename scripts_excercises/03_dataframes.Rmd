...
#das ist eine Abkürzung für den Pfad (nicht der Gesamte, damit auch andere das Skript hier nutzen können) -> der Punkt bedeutet "Du gehst von hier aus, wo das Projekt ist (script excercises)
```
